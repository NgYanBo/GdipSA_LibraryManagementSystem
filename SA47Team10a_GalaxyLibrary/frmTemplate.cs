...
namespace SA47Team10a_GalaxyLibrary
{
    public partial class frmTemplate : Form
    {
        ...
        /*each time when any of forms that inherit from frmTemplate loads, 
          it checks the property Name. if it is "Venkat", then it makes the 
          btnAdmin visible. When the user clicks on btnAdmin, it instantiates bossVenkat.cs!*/
